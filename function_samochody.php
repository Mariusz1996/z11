	...
	function samochody()
	{
		...
		else
		{
			...
			echo '<table align="center" border="1">';
				echo '<tr>';
					echo '<td>ID Samochodu</td><td><center>Data</center></td><td>Pracownik</td><td>Właściciel</td><td>Marka</td><td>Model</td><td>Rocznik</td><td>Cena</td>';
				echo '</tr>';
			
			$wynik = $connect->query("SELECT * FROM samochod ORDER BY idsamochod ASC");
